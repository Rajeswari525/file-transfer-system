package com.fts.fileTransfer;

import com.amazonaws.services.lambda.runtime.Context;
import com.amazonaws.services.lambda.runtime.LambdaLogger;
import com.amazonaws.services.lambda.runtime.RequestHandler;
import com.fts.fileTransfer.dto.KafkaEventDto;
import com.fts.fileTransfer.kafka.KafkaConsumerUtil;
import com.fts.fileTransfer.kafka.KafkaProducerUtil;

import java.sql.Connection;
import java.sql.DriverManager;
import java.util.Map;

public class FileTransferHandler implements RequestHandler<Map<String,String>, Map<String,String>> {
    ...
    public Map<String,String> handleRequest(Map<String, String> event, Context context) {
        ...
        KafkaConsumerUtil consumer = new KafkaConsumerUtil("start.fileTransfer.topic");
...
//        }
        ...
        String lambdaName = "FileTransferLambda";
        ...
        try {
            ...
            producer.sendMessage("start.storedProcInvoke.topic", kafkaEventDto);
